...
define("bui/util", function() {
		...
		return t.augment(i, {
			...
			_initEvents: function(e) {
				...
				if (n)
					for (var r in n) n.hasOwnProperty(r) && t.on(r, n[r])
			},
			...
			publish: function(e, n) {
				var r = this,
					i = r._bubblesEvents;
				if (n.bubbles) t.Array.indexOf(e, i) === -1 && i.push(e);
				else {
			...
			switch (typeof p) {
				...
				case "object":
					...
					if (l && typeof l == "object") {
						...
						for (r in p) Object.hasOwnProperty.call(p, r) && (i = h(r, p), i && f.push(c(r) + (u ? ": " : ":") + i));
					return i = f.length === 0 ? "{}" : u ? "{\n" + u + f.join(",\n" + u) + "\n" + o + "}" : "{" + f.join(",") + "}", u = o, i
			}
		}
		...
		typeof r.stringify != "function" && (r.stringify = function(e, t, n) {
			...
			l = t;
			if (!t || typeof t == "function" || typeof t == "object" && typeof t.length == "number") return h("", {
				"": e
			});
		...
		function s(e, t, n, r, i) {
			var s = n;
			return e.fire(t + BUI.ucfirst(n) + "Change", {
				attrName: s,
				prevVal: r,
				newVal: i
			})
		...
		function i(e, n) {
			BUI.isFunction(n) ? t[e] = {
				constructor: n,
				priority: 0
			} : (n.priority = n.priority || 0, t[e] = n)
		}
		...
		var t = {},
			...
			u = {
				...
				getCssClassWithPrefix: s,
				getXClassByConstructor: r,
				getConstructorByXClass: n,
				setConstructorByXClass: i
			};
		return u
	}),
	function() {
		...
		function a(e, t, n) {
			...
			while (r) {
				a = [];
				if (u = r.mixins)
					for (var f = 0; f < u.length; f++) s = u[f], s && (n != "constructor" && (s.prototype.hasOwnProperty(n) ? s = s.prototype[n] : s = null), s && a.push(s));
		...
		function f(e) {
			...
			while (t) {
				...
				if (n = t.mixins)
					for (i = n.length - 1; i >= 0; i--) r = n[i] && n[i].prototype.__destructor, r && r.apply(e);
		...
		function s(e) {
			var n = {
				...
				s, o, u, a, f = e.ownerDocument,
				l = f.body,
				c = f.documentElement;
			for (s = e; s = i(s);)
				if ((!t.ie || s.clientWidth != 0) && s != l && s != c && $(s).css("overflow") != "visible") {
					var h = $(s).offset();
		...
		function v(e) {
			var t = e.attr("class"),
				r = new RegExp("s?" + n + "[a-z]{2}-[a-z]{2}", "ig"),
				i = r.exec(t);
		...
		return e.ATTRS = {
			...
			_setTrigger: function() {
				...
				var e = this,
					...
					n = e.get("triggerHideEvent"),
					r = e.get("triggerCallback"),
					i = e.get("trigger"),
					s = e.get("delegateTigger"),
					o = $(i);
		...
		function r() {}
		var e = BUI.wrapBehavior,
			t = BUI.getWrapBehavior;
		return r.ATTRS = {
			autoHideType: {
				value: "click"
			},
		...
		n.ATTRS = {
			closeTpl: {
				value: '<a tabindex="0" href=\'javascript:void("\u5173\u95ed")\' role="button" class="' + e + "close" + '">' + '<span class="' + e + "close-x" + '">\u5173\u95ed<' + "/span>" + "<" + "/a>"
			},
			closable: {
				value: !0
			},
		...
		}, t.prototype = {}, t.View = e, t
	}), define("bui/component/uibase/stdmod", function() {
		function t() {}

		function n(t, n) {
			var r = t.get("contentEl"),
				i = t.get(n);
		...
		return t.ATTRS = {
			...
			afterSelected: function(e, t, n) {
				var r = this;
				t ? (r.fire("itemselected", {
					item: e,
					domTarget: n
				}), r.fire("selectedchange", {
					item: e,
					domTarget: n,
					selected: t
					...
					item: e,
					domTarget: n
				}), r.get("multipleSelect") && r.fire("selectedchange", {
					item: e,
					domTarget: n,
					selected: t
				}))
		...
		var t = e("bui/component/uibase/selection"),
			n = function() {};
		n.ATTRS = {
			items: {
				view: !0
		...
		var t = e("bui/component/uibase"),
			n = e("bui/component/manage"),
			r = e("bui/component/view"),
			i = e("bui/component/loader"),
			s = BUI.wrapBehavior,
			o = BUI.getWrapBehavior,
			p = t.extend([t.Decorate, t.Tpl, t.ChildCfg, t.KeyNav, t.Depends], {
				...
				getNextUniqueId: function() {
					var e = this,
						t = n.getXClassByConstructor(e.constructor);
					return BUI.guid(t)
				},
				createDom: function() {
					var e = this,
	...
	function() {
		...
		return BUI.extend(i, n), BUI.mixin(i, [t]), BUI.augment(i, {
			_read: function(e, t) {
				var n = this,
					...
					a = n.get("data"),
					f = [];
				n.sortData(s, o), u ? (f = a.slice(i, i + u), t({
					rows: f,
					results: a.length
				})) : (f = a.slice(i), t(f))
			}
		...
		return r.ATTRS = {
			...
			load: function(e, n) {
				var r = this,
					i = r.get("proxy"),
					s = r.get("lastParams");
				t.mix(!0, s, r.getAppendParams(), e), r.fire("beforeload", {
					params: s
				}), e = t.cloneObject(s), i.read(s, function(t) {
		...
		return s.ATTRS = {
			...
			add: function(e, t, n) {
				var r = this;
				return e = r._add(e, t, n), r.fire("add", {
					node: e,
					index: n
				}), e
			},
			...
			remove: function(e) {
				var n = e.parent || _self.get("root"),
					r = t.Array.indexOf(e, n.children);
			...
			setResult: function(e) {
				var t = this,
					n = t.get("proxy"),
					i = t.get("root");
				n instanceof r.Memery ? (t.set("data", e), t.load({
					id: i.id
				})) : t.setChildren(i, e)
			},
			...
			afterProcessLoad: function(e, n) {
				var r = this,
					i = n.id,
					s = r.get("dataProperty"),
					o = r.findNode(i) || r.get("root");
				t.isArray(e) ? r.setChildren(o, e) : r.setChildren(o, e[s]), r.fire("load", {
					node: o,
					params: n
				})
			},
		...
		var t = e("bui/data/proxy"),
			n = e("bui/data/abstractstore"),
			r = e("bui/data/sortable"),
			u = function(e) {
		...
		return u.ATTRS = {
			...
			setResult: function(e) {
				var n = this,
					r = n.get("proxy");
				r instanceof t.Memery ? (n.set("data", e), n.load({
					start: 0
				})) : n._setResult(e)
			},
			remove: function(e, t) {
				...
				t = t || n._getDefaultMatch(), BUI.isArray(e) || (e = [e]), $.each(e, function(e, r) {
					var e = n.findIndexBy(r, t),
						u = i(e, n.getResult());
					!o(u, n.get("newRecords")) && !o(u, n.get("deletedRecords")) && n.get("deletedRecords").push(u), s(u, n.get("newRecords")), s(u, n.get("modifiedRecords")), n.fire("remove", {
						record: u
					})
				})
			},
			...
			update: function(e, t) {
				var n = e,
					...
					i = null,
					s = null;
				t && (i = r._getDefaultMatch(), s = r.findIndexBy(e, i), s >= 0 && (n = r.getResult()[s])), n = BUI.mix(n, e), !o(n, r.get("newRecords")) && !o(n, r.get("modifiedRecords")) && r.get("modifiedRecords").push(n), r.fire("update", {
					record: n
				})
			},
			_addRecord: function(e, t) {
				var n = this.getResult();
				t == undefined && (t = n.length), n.splice(t, 0, e), this.fire("add", {
					record: e,
					index: t
				})
			},
			...
			_getPageParams: function() {
				...
				return params = {
					...
					limit: r,
					pageIndex: i
				}, e.get("remoteSort") && BUI.mix(params, t), params
			},
			getAppendParams: function() {
			...
			afterProcessLoad: function(e, t) {
				var n = this,
					...
					i = t.start,
					s = t.limit,
					o = n.get("totalProperty");
				BUI.isArray(e) ? n._setResult(e) : n._setResult(e[r], e[o]), n.set("start", i), s && n.set("pageIndex", i / s), n.get("remoteSort") || n._sortData(), n.fire("load", {
					params: t
				})
			},
		...
		var t = e("bui/common"),
			n = t.namespace("Overlay");
		return t.mix(n, {
			Overlay: e("bui/overlay/overlay"),
			Dialog: e("bui/overlay/dialog"),
			Message: e("bui/overlay/message")
		}), t.mix(n, {
			OverlayView: n.Overlay.View,
			DialogView: n.Dialog.View
		}), t.Message = t.Overlay.Message, n
		...
		var t = e("bui/common"),
			...
			o = n.Controller.extend([i.Position, i.Align, i.Close, i.AutoShow, i.AutoHide], {
				...
				ATTRS: {
					...
					arrowTpl: {
						value: '<s class="' + r + '"><s class="' + r + '-inner"></s></s>'
					},
					visibleMode: {
						value: "visibility"
					},
		...
		var t = e("bui/overlay/overlay"),
			n = BUI.Component.UIBase,
			r = "header-title",
			i = BUI.prefix,
			s = 20,
			...
			u = t.extend([n.StdMod, n.Mask, n.Drag], {
				show: function() {
					var e = this;
				...
				_createButton: function(e, t) {
					var n = this,
						r = '<button class="' + e.elCls + '">' + e.text + "</button>",
						i = $(r).appendTo(t);
					i.on("click", function() {
		...
		function o(e, t) {
			return function(n, r, i) {
				BUI.isString(r) && (i = r, r = null), i = i || t, r = r || f, u({
					buttons: e,
					icon: i,
					msg: n,
					success: r
		...
		var t = e("bui/overlay/dialog"),
			...
			i = t.extend({
				...
				_setContent: function() {
					var e = this,
						t = e.get("body"),
						n = BUI.substitute(e.get("contentTpl"), {
							msg: e.get("msg"),
				...
				ATTRS: {
					...
					contentTpl: {
						value: '{iconTpl}<div class="' + n + 'message-content">{msg}</div>'
					}
				}
			}, {
				xclass: "message",
	...
	function() {
		...
		define("bui/list", ["bui/common", e + "list", e + "listitem", e + "simplelist", e + "listbox"], function(t) {
			...
			return n.mix(r, {
				...
				ListItemView: r.ListItem.View,
				SimpleListView: r.SimpleList.View
			}), r
		})
		...
		function s(e, t) {
			var n = t,
				r = n.get("itemCls"),
				i = n.get("itemStatusCls");
			return i && i[e] ? i[e] : r + "-" + e
		}

		function u(e, n) {
			var i = e.attributes,
				o = n.get("itemStatusFields"),
				u = {};
		...
		var t = e("bui/common"),
			n = t.Component.UIBase.Selection,
			r = "data-",
			i = t.Component.UIBase.List,
			o = function() {};
		o.ATTRS = {
			items: {}
		}, o.prototype = {
			...
			setItemStatusCls: function(e, t, n) {
				var r = this,
					i = r.getItemStatusCls(e),
					s = n ? "addClass" : "removeClass";
				t && $(t)[s](i)
			},
			hasStatus: function(e, t) {
				var n = this,
					r = n.getItemStatusCls(e);
				return $(t).hasClass(r)
			},
		...
		return a.ATTRS = t.merge(!0, i.ATTRS, n.ATTRS, {
			...
			__bindUI: function() {
				...
				var e = this,
					t = e.get("selectedEvent"),
					n = e.get("itemCls"),
					r = e.get("view").getItemContainer();
				r.delegate("." + n, "click", function(n) {
					var r = $(n.currentTarget),
						s = e.getItemByElement(r);
					if (e.isItemDisabled(s, r)) return;
					var o = e.fire("itemclick", {
						item: s,
						element: r[0],
						domTarget: n.target
					});
			...
			getSelected: function() {
				var e = this,
					t = e.get("view").getFirstElementByStatus("selected");
				return e.getItemByElement(t) || null
			},
			getItemsByStatus: function(e) {
				var n = this,
					r = n.get("view").getElementsByStatus(e),
					i = [];
			...
			getSelection: function() {
				var e = this,
					n = e.get("view").getSelectedElements(),
					r = [];
				return t.each(n, function(t) {
					r.push(e.getItemByElement(t))
				}), r
		...
		var t = e("bui/common"),
			n = t.Component.UIBase,
			r = e("bui/list/domlist"),
			i = e("bui/list/keynav"),
			s = t.prefix + "list-item",
			o = t.Component.View.extend([r.View], {
			...
			u = t.Component.Controller.extend([r, n.Bindable, i], {
				bindUI: function() {
					var e = this,
						t = e.get("itemCls"),
						n = e.get("view").getItemContainer();
				...
				ATTRS: {
					...
					itemTpl: {
						view: !0,
						value: '<li role="option" class="' + s + '">{text}</li>'
					},
					tpl: {
						value: "<ul></ul>"
					},
		...
		var t = BUI.Component,
			n = t.UIBase,
			r = t.Controller.extend([n.ChildList], {}, {
				ATTRS: {
					elTagName: {
						view: !0,
						value: "ul"
		...
		var t = e("bui/overlay").Overlay,
			n = t.extend({
				bindUI: function() {
					var e = this,
						t = e.get("innerControl"),
						n = e.get("hideEvent"),
						r = $(e.get("trigger"));
					r.on(e.get("triggerEvent"), function(t) {
						if (e.get("autoSetValue")) {
							var n = e.get("valueField") || e.get("textField") || this,
								r = $(n).val();
						...
						var n = e.get("curTrigger"),
							r = e.get("textField") || n,
							i = e.get("valueField"),
							s = e.getSelectedValue(),
							o = !1;
						if (r) {
							var u = e.getSelectedText(),
								a = $(r).val();
							u != a && ($(r).val(u), o = !0)
						}
						if (i) {
	...
	function() {
		...
		var t = e("bui/common"),
			n = t.prefix,
			r = e("bui/overlay").Overlay,
			i = "data-tip",
			s = n + "form-tip-container",
			o = r.extend({
				initializer: function() {
					var e = this,
						t = e.get("render");
		...
		var t = e("bui/common"),
			n = t.Component,
			r = e("bui/form/tips").Item,
			i = e("bui/form/valid"),
			s = e("bui/form/remote"),
			o = t.prefix + "form-field-error",
			u = "data-error",
			a = n.View.extend([s.View, i.View], {
				renderUI: function() {
					var e = this,
						t = e.get("control");
					if (!t) {
						var n = e.get("controlTpl"),
							r = e.getControlContainer();
						if (n) {
							var t = $(n).appendTo(r);
							e.set("control", t)
						}
			...
			f = n.Controller.extend([s, i], {
				...
				validControl: function(e) {
					...
					return e = e || t.getControlValue(), preError = t.get("error"), n = t.getValidError(e), t.setInternal("hasValid", !0), n ? (t._setError(n), t.fire("error", {
						msg: n,
						value: e
					}), preError !== n && t.fire("validchange", {
						valid: !1
					})) : (t._clearError(), t.fire("valid"), preError && t.fire("validchange", {
						valid: !0
					})), !n
				},
				focus: function() {
			...
			s = n.extend({
				...
				PARSER: {
					datePicker: function(e) {
						return e.hasClass("calendar-time") ? {
							showTime: !0
						} : {}
					}
				}
		...
		var t = e("bui/form/basefield"),
			n = t.View.extend({
				_uiSetValue: function(e) {
					var t = this,
						n = t.get("textEl"),
						r = t.getControlContainer(),
						i = t.get("renderer"),
						s = i ? i(e) : e,
						o = t.get("width"),
						u = 0,
						a;
					n && n.remove(), s = s || "&nbsp;", a = BUI.substitute(t.get("textTpl"), {
						text: s
					}), n = $(a).appendTo(r), u = n.outerWidth() - n.width(), n.width(o - u), t.set("textEl", n)
				}
			}, {
				ATTRS: {
					textEl: {},
	...
	function() {
		...
		var t = e("bui/common"),
			n = e("bui/form/field"),
			r = e("bui/form/groupvalid"),
			i = t.prefix,
			s = "form-field",
			o = i + s,
			u = i + "form-group",
			a = "input,select,textarea",
			c = t.Component.View.extend([r.View]),
			h = t.Component.Controller.extend([r], {
				...
				getRecord: function() {
					...
					return t.each(r, function(r) {
						var i = r.get("name"),
							s = e._getFieldValue(r);
						if (!n[i]) n[i] = s;
						else if (t.isArray(n[i]) && s != null) n[i].push(s);
						else if (s != null) {
							var o = [n[i]];
							o.push(s), n[i] = o
						}
		...
		var t = e("bui/form/group/base"),
			n = e("bui/data"),
			r = BUI.Component.UIBase.Bindable,
			s = t.extend([r], {
				initializer: function() {
					var e = this,
						t = e.get("url"),
						r = e.get("store") || e._getStore();
				...
				onLoad: function(e) {
					var t = this,
						n = e ? e.node : t.get("store").get("root");
		...
		var t = e("bui/common"),
			n = e("bui/picker").ListPicker,
			r = t.prefix,
			s = t.Component,
			o = n,
			u = r + "select-input",
			a = s.Controller.extend({
				initializer: function() {
					var e = this,
						t = e.get("multipleSelect"),
						n, s = e.get("picker");
		...
		var t = e("bui/common"),
			n = e("bui/select/select"),
			r = t.prefix + "combox-input",
			s = n.extend({
				renderUI: function() {
					var e = this,
						t = e.get("picker");
		...
		"use strict";
		var t = e("bui/common"),
			n = e("bui/select/combox"),
			r = 200,
			i = "",
			s = n.extend({
				bindUI: function() {
					var e = this,
						t = e.get("el").find("input"),
			...
			maskElement: function(e, n, o) {
				...
				if (!a.length) {
					...
					if (n) {
						...
						try {
							c = (u.height() - l.height()) / 2, h = (u.width() - l.width()) / 2, l.css({
								left: h,
								top: c
							})
						} catch (p) {
		...
		var t = e("bui/common"),
			...
			s = i + "menu-item-open",
			o = "x-caret",
			u = i + "menu-item-collapsed",
			a = "data-id",
			f = n.View.extend([r.ListItemView, r.CollapseableView], {
				_uiSetOpen: function(e) {
					var t = this,
						n = t.getStatusCls("open");
			...
			l = n.Controller.extend([r.ListItem, r.Collapseable], {
				renderUI: function() {
					var e = this,
						n = e.get("el"),
						r = e.get("id"),
				...
				containsElement: function(e) {
					var t = this,
						n, r = l.superclass.containsElement.call(t, e);
					return r || (n = t.get("subMenu"), r = n && n.containsElement(e)), r
				},
				_uiSetOpen: function(e) {
					var t = this,
						n = t.get("subMenu"),
						r = t.get("subMenuAlign");
					if (n)
						if (e) r.node = t.get("el"), n.set("align", r), n.show();
						else {
							var i = n.get("align");
				...
				ATTRS: {
					...
					arrowTpl: {
						value: '<span class="' + o + " " + o + '-left"></span>'
					},
					events: {
						value: {
							afterOpenChange: !0
		...
		var t = e("bui/common"),
			n = t.Component,
			r = n.UIBase,
			i = n.Controller.extend([r.ChildList], {
				bindUI: function() {
					var e = this;
					e.on("click", function(t) {
						var n = t.target,
							r = e.get("multipleSelect");
		...
		var t = e("bui/common"),
			n = e("bui/menu/menuitem"),
			r = e("bui/menu/popmenu"),
			i = t.prefix,
			s = i + "menu-item-link",
			o = i + "menu-item-icon",
			u = t.Component,
			...
			f = n.extend({
				...
				ATTRS: {
					...
					tpl: {
						value: '<a class="' + s + '" href="#">        <span class="' + o + ' {iconCls}"></span><span class="' + i + 'menu-item-text">{text}</span></a>'
					}
				}
			}, {
			...
			o = n.extend({
				...
				bindUI: function() {
					...
					t.each(n, function(e) {
						...
						var n = t.item,
							r = $(t.domTarget).closest("." + i);
						if (r.length) {
							var o = n.get("collapsed");
							n.set("collapsed", !o)
						} else n.get("el").hasClass(s) && (e.fire("menuclick", {
							item: n
						}), e.clearSelection(), e.setSelected(n))
					})
				},
				getItems: function() {
					var e = this,
		...
		var t = e("bui/common"),
			...
			a = n.Controller.extend({
				...
				handleDblClick: function(e) {
					var t = this;
					t.fire("closing") !== !1 && t.close(), t.fire("dblclick", {
						domTarget: e.target,
						domEvent: e
					})
				},
				...
				ATTRS: {
					...
					tpl: {
						view: !0,
						value: '<span class="' + r + '"></span><s class="' + i + '"></s>'
					},
					xview: {
						value: u
					}
		...
		var t = e("bui/common"),
			...
			f = r.View.extend({
				...
				_uiSetHeight: function(e) {
					var t = this,
						n = t.get("el"),
						r = n.find(".tab-nav-bar"),
						i = t.getTabContentContainer();
			...
			l = r.Controller.extend({
				addTab: function(e, n) {
					var r = this,
						i = e.id || t.guid("tab-item"),
						s = r.getItemById(i);
					if (s) {
						var o = !1;
				...
				_scrollToItem: function(e) {
					var t = this,
						...
						r = n.position(),
						i = t._getDistanceToEnd(e, n, r),
						s = t._getDistanceToBegin(e, r);
					if (n.width() < n.parent().width()) t._scrollTo(n, 0);
					else if (s < 0) t._scrollTo(n, r.left - s);
					else if (i > 0) t._scrollTo(n, r.left + i * -1);
					else if (r.left < 0) {
						var o = t._getLastDistance(n, r),
							u = 0;
				...
				_getDistanceToEnd: function(e, t, n) {
					var r = this,
						t = t || r.getContentElement(),
						i = t.parent().width(),
						n = n || t.position(),
						s = r._getDistanceToBegin(e, n),
						o = s + a - i;
					return o
				},
				...
				_setItemActived: function(e) {
					var t = this,
						n = t.getActivedItem();
					if (e === n) return;
					n && n.set("actived", !1), e && (e.get("actived") || e.set("actived", !0), e.get("visible") && t._scrollToItem(e), t.fire("activeChange", {
						item: e
					}))
				}
			}, {
		...
		var t = e("bui/common"),
			n = t.Component,
			r = n.UIBase,
			i = n.View.extend([r.ListItemView], {}, {
		...
		var t = e("bui/common"),
			n = t.namespace("ProgressBar");
		return t.mix(n, {
			Base: e("bui/progressbar/base"),
			Load: e("bui/progressbar/load")
		}), n
	}), define("bui/progressbar/base", ["bui/common"], function(e) {
		var t = e("bui/common"),
			n = t.Component.View.extend({
			...
			r = t.Component.Controller.extend({}, {
				ATTRS: {
					percent: {
						view: !0,
						value: 0
		...
		var t = e("bui/progressbar/base"),
			...
			s = t.extend({
				...
				ATTRS: {
					...
					events: {
						value: ["start", "loadchange", "completed"]
					}
				}
			}, {
		...
		var t = e("bui/common"),
			n = t.Component,
			r = e("bui/overlay").Overlay,
			i = e("bui/list").SimpleList,
			s = e("bui/toolbar"),
			o = t.prefix,
			u = "x-monthpicker-month",
			a = "data-month",
			f = "data-year",
			l = "x-monthpicker-year",
			c = "x-monthpicker-yearnav",
			h = "x-monthpicker-selected",
			p = "x-monthpicker-item",
			...
			g = i.extend({
				...
				ATTRS: {
					...
					itemTpl: {
						view: !0,
						value: '<li class="' + p + " " + l + '"><a href="#" hidefocus="on">{text}</a></li>'
					},
					tpl: {
						view: !0,
		...
		var t = e("bui/common"),
			...
			i = "year-text",
			s = "month-text",
			o = "x-datepicker-arrow",
			u = "x-datepicker-prev",
			a = "x-datepicker-next",
			f = r.Controller.extend({
				bindUI: function() {
					var e = this,
						t = e.get("el");
				...
				setMonth: function(e, t) {
					var n = this,
						r = n.get("year"),
						i = n.get("month");
					if (e !== r || t !== i) n.set("year", e), n.set("month", t), n.fire("monthchange", {
						year: e,
						month: t
					})
				},
				nextMonth: function() {
					var e = this,
						t = new Date(e.get("year"), e.get("month") + 1);
		...
		var t = e("bui/common"),
			...
			r = t.Date,
			i = "x-datepicker-date",
			s = "x-datepicker-today",
			o = "x-datepicker-disabled",
			u = "x-datepicker-active",
			a = "data-date",
			f = "isoDate",
			l = "x-datepicker-selected",
			c = 6,
			h = {
				deactive: "prevday",
				active: "active",
			...
			d = n.View.extend({
				...
				_setSelectedDate: function(e) {
					var t = this,
						n = t._findDateElement(e);
					t._clearSelectedDate(), n && n.addClass(l)
				}
			}, {
				ATTRS: {}
			}),
			v = n.Controller.extend({
				initializer: function() {
					var e = this,
						t = new Date;
				...
				_uiSetSelected: function(e, t) {
					var n = this;
					t && t.prevVal && r.isDateEquals(e, t.prevVal) || (n.setMonth(e.getFullYear(), e.getMonth()), n.get("view")._setSelectedDate(e), n.fire("selectedchange", {
						date: e
					}))
				},
		...
		var t = e("bui/common"),
			...
			r = "x-datepicker-time",
			i = "x-datepicker-hour",
			s = "x-datepicker-minute",
			o = "x-datepicker-second",
			u = "x-timepicker",
			a = e("bui/picker").ListPicker,
			f = e("bui/calendar/monthpicker"),
			l = e("bui/calendar/header"),
			c = e("bui/calendar/panel"),
			h = e("bui/toolbar"),
			p = t.Component,
			d = t.Date,
			w = p.Controller.extend({
				initializer: function() {
					var e = this,
						t = e.get("children"),
						n = new l,
						r = new c,
						i = e.get("footer") || e._createFooter(),
				...
				_uiSetSelectedDate: function(e) {
					var t = this,
						n = e.getFullYear(),
						r = e.getMonth();
					t.get("header").setMonth(n, r), t.get("panel").set("selected", e), t.fire("datechange", {
						date: e
					})
				},
				...
				ATTRS: {
					...
					timeTpl: {
						value: '<input type="text" readonly class="' + r + " " + i + '" />:<input type="text" readonly class="' + r + " " + s + '" />:<input type="text" readonly class="' + r + " " + o + '" />'
					},
					selectedDate: {
						value: v()
					},
		...
		var t = e("bui/common"),
			...
			s = n.extend({
				...
				getSelectedValue: function() {
					var e = this,
						t = e.get("calendar"),
						n = i.getDate(t.get("selectedDate"));
		...
		var t = e("bui/common"),
			...
			h = n.SimpleListView.extend({
				...
				_createColumn: function(e, n) {
					var r = this,
						i = t.substitute(r.get("columnTpl"), e);
					$(i).appendTo(n)
				},
				getItemTpl: function(e, n) {
					var r = this,
			...
			p = t.List.SimpleList.extend({
				...
				ATTRS: {
					...
					rowTpl: {
						view: !0,
						value: '<tr class="' + u + ' {oddCls}">{cellsTpl}</tr>'
					},
					cellTpl: {
						view: !0,
		...
		var t = e("bui/common"),
			...
			o = "ASC",
			u = "DESC",
			a = n + "grid-hd-menu-trigger",
			f = "grid-hd-menu-trigger",
			l = t.Component.View.extend({
				setTplContent: function(e) {
					var t = this,
						n = t.get("sortTpl"),
						i = t.get("triggerTpl"),
		...
		return c.Empty = c.extend({}, {
			ATTRS: {
				...
				tpl: {
					view: !0,
					value: '<div class="' + n + 'grid-hd-inner"></div>'
				}
			}
		}, {
			...
			l = o.extend({
				...
				forceFitColumns: function() {
					...
					var e = this,
						...
						n = e.get("width"),
						r = n,
						i = e.getColumnOriginWidth(),
						s = 0,
						o = 0,
						a = null,
						f = e._isAllowScrollLeft();
					if (n) {
						f && (n -= u, r = n);
						var c = 0;
						$.each(t, function(e, t) {
						...
						var h = Math.floor(r / c),
							p = r / i;
						if (p === 1) return;
						$.each(t, function(t, n) {
							if (n.get("visible") && n.get("resizable")) {
								var r = e._getColumnBorderWith(n, t),
									i = n.get("originWidth");
			...
			B = o.SimpleListView.extend({
				...
				updateItem: function(e) {
					...
					if (i >= 0) return o = n.findElement(e), t.each(s, function(t) {
						var r = n.findCell(t.get("id"), $(o)),
							i = r.find("." + C),
							s = n._getCellText(t, e);
						i.html(s)
					}), o
				},
				...
				_createHeaderRow: function() {
					var e = this,
						n = e._getColumns(),
						r = e.get("tbodyEl"),
						i = e.get("headerRowTpl"),
						s, o = [];
					return $.each(n, function(t, n) {
						o.push(e._getHeaderCellTpl(n))
					}), e.get("useEmptyCell") && o.push(e._getEmptyCellTpl()), i = t.substitute(i, {
						cellsTpl: o.join("")
					}), s = $(i).appendTo(r), s
				},
				...
				_getCellText: function(e, n) {
					var r = this,
						i = e.get("dataIndex"),
						s = e.get("cellTpl") || r.get("cellTextTpl"),
						o = r._getCellInnerText(e, i, n);
					return t.substitute(s, {
						text: o,
						tips: r._getTips(e, i, n)
					})
				},
				...
				_getHeaderCellTpl: function(e) {
					var n = this,
						r = n.get("headerCellTpl");
					return t.substitute(r, {
						id: e.get("id"),
						width: e.get("width"),
						hideCls: e.get("visible") ? "" : M
					})
			...
			j = o.SimpleList.extend({
				...
				_bindHeaderEvent: function() {
					...
					t.on("afterWidthChange", function(e) {
						...
						var i = r.target;
						i !== t && (n.setColumnVisible(i), e.fire("columnvisiblechange", {
							column: i
						}))
					}), t.on("click", function(n) {
						var r = n.target;
						r !== t && e.fire("columnclick", {
							column: r,
						...
						e.get("rendered") && (e.fire("columnadd", {
							column: t.column,
							index: t.index
						}), e.resetColumns())
					}), t.on("remove", function(t) {
						e.get("rendered") && (e.resetColumns(), e.fire("columnremoved", {
							column: t.column,
							index: t.index
						}))
					})
				...
				_initLoadMask: function() {
					var e = this,
						n = e.get("loadMask");
					n && !n.show && (n = new t.Mask.LoadMask({
						el: e.get("el")
					}), e.set("loadMask", n))
				},
				_uiSetWidth: function(e) {
				...
				ATTRS: {
					...
					headerRowTpl: {
						view: !0,
						value: '<tr class="' + l + 'grid-header-row">{cellsTpl}</tr>'
					},
					headerCellTpl: {
						view: !0,
					...
					rowTpl: {
						view: !0,
						value: '<tr class="' + w + ' {oddCls}">{cellsTpl}</tr>'
					},
					cellTpl: {
						view: !0,
					...
					cellTextTpl: {
						view: !0,
						value: '<span class="' + L + ' " title = "{tips}">{text}</span>'
					},
					events: {
						value: {
							aftershow: !1,
					...
					tpl: {
						value: '<div class="' + m + '" style="display:none"></div><div class="' + c + '"></div><div class="' + h + '"></div><div style="display:none" class="' + g + '"></div>'
					},
					innerBorder: {
						sync: !1,
						value: !0
	...
	function() {
		...
		return t.extend(a, t.Base), a.ATTRS = {
			...
			_resetColumnsVisible: function(e) {
				var t = this,
					n = e.findItemById(o),
					r = n.get("subMenu") || t._initColumnsMenu(n),
			...
			_initMenu: function() {
				...
				return t || (r = e.get("items"), $.each(r, function(e, t) {
					...
					children: r,
					elCls: "grid-menu"
				}), e._initMenuEvent(t), e.set("menu", t)), t
			},
		...
		return t.extend(l, t.Base), l.ATTRS = {
			...
			cellInner: {
				value: '<span class="' + s + '"><i class="' + s + '-icon"></i></span>'
			},
			rowTpl: {
				value: '<tr class="' + u + '"><td class="' + a + '"></td></tr>'
			},
			renderer: {},
			...
			_onCollapse: function(e, t, n) {
				...
				if (i || !i.length) $(i).addClass(f), r.fire("collapse", {
					record: e,
					row: i[0]
				})
			},
		...
		t.extend(o, t.Base), o.ATTRS = {
			...
			column: {},
			cellInner: {
				value: '<div class="' + r + '-container"><span class="' + i + '"></span></div>'
			}
		}, t.augment(o, {
		...
		t.extend(u, t.Base), u.ATTRS = {
			...
			column: {},
			cellInner: {
				value: '<div class="' + n + 'grid-radio-container"><input  class="' + s + '" type="radio"></div>'
			}
		}, t.augment(u, {
			createDom: function(e) {
				var t = this,
		...
		return d.ATTRS = {
			...
			_processSummary: function(e) {
				...
				if (!e) return;
				var r =
					e[t.get("pageSummaryField")],
					i = e[t.get("summaryField")];
			...
			_getSummaryTpl: function(e) {
				...
				return $.each(i, function(n, r) {
					if (r.get("visible")) {
						...
						if (r.get("summary")) {
							o.push(l(a - u - 1));
							var i = t._getSummaryCellText(r, e),
								s = c(i, r.get("id"));
							o.push(s), u = a
						}
					}
		...
		var t = BUI.prefix + "grid-cell-inner",
			n = BUI.prefix + "grid-cell-error";
		return BUI.extend(r, BUI.Base), r.ATTRS = {
			...
			errorTpl: {
				value: '<span class="x-icon ' + n + ' x-icon-mini x-icon-error" title="{error}">!</span>'
			},
			isInitEditors: {
				value: !1
			},
			...
			_showCellError: function(e, n) {
				var r = this,
					i = BUI.substitute(r.get("errorTpl"), {
						error: n
					}),
					s = e.find("." + t);
				$(i).appendTo(s)
		...
		var t = e("bui/grid/plugins/editing"),
			n = BUI.prefix + "grid-body",
			r = BUI.prefix + "grid-cell",
			i = function(e) {
				i.superclass.constructor.call(this, e)
			};
		return i.ATTRS = {
		...
		return i.ATTRS = {
			...
			wrapValidator: function(e) {
				var t = this;
				return function(n) {
					var r = t.get("curEditor"),
						i = r ? r.getValue() : t.get("record");
					if (i) return e(n, i)
				}
			},
			focusEditor: function(e, t) {
			...
			beforeShowEditor: function(e, n) {
				...
				e.set("width", u.width()), t.each(s, function(e) {
					if (!e.get("visible")) n.set("visible", !1);
					else {
						var t = e.get("dataIndex"),
							n = o.getField(t),
							r = e.get("el").outerWidth() - n.getAppendWidth();
						n.set("width", r)
					}
				})
			},
		...
		return w.ATTRS = {
			...
			_getIconsTpl: function(e) {
				var t = this,
					r = e.level,
					i = t.get("startLevel"),
					s = t.get("iconWraperTpl"),
					o = [],
					u;
				for (u = i; u < r; u += 1) o.push(t._getLevelIcon(e, u));
				return o.push(t._getExpandIcon(e)), o.push(t._getCheckedIcon(e)), o.push(t._getNodeTypeIcon(e)), n.substitute(s, {
					icons: o.join("")
				})
			},
			...
			_getNodeTypeIcon: function(e) {
				var t = this,
					n = e.cls ? e.cls : e.leaf ? t.get("leafCls") : t.get("dirCls");
				return t._getIcon(n)
			},
			...
			_resetIcons: function(e, t) {
				var n = this,
					r = n.get("iconContainer"),
					i, s = n._getIconsTpl(e);
		...
		var t = e("bui/common"),
			n = e("bui/list"),
			r = e("bui/tree/treemixin"),
			i = n.SimpleList.extend([r], {}, {
				ATTRS: {
					itemCls: {
						value: t.prefix + "tree-item"
					},
					itemTpl: {
						value: "<li>{text}</li>"
					},
		...
		var t = e("bui/common"),
			n = t.namespace("Tooltip"),
			r = e("bui/tooltip/tip"),
			i = e("bui/tooltip/tips");
		return t.mix(n, {
			Tip: r,
			Tips: i
		}), n
		...
		var t = e("bui/common"),
			...
			o = n.OverlayView.extend({
				...
				_uiSetTitle: function(e) {
					var n = this,
						r = n.get("titleTpl"),
						i = n._getTitleContainer(),
						s = n.get("titleEl"),
						o;
					s && s.remove(), e = e || "", t.isString(e) && (e = {
						title: e
					}), o = t.substitute(r, e), s = $(o).appendTo(i), n.set("titleEl", s)
				},
		...
		return i.ATTRS = {
			...
			_setTitle: function(e, r) {
				var i = this,
					s = e.attr("data-title"),
					o = e.attr("data-align") || i.get("defaultAlignType");
